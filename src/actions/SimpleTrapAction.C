...
registerMooseAction("achlysApp", SimpleTrapAction, "add_trap_variables");
registerMooseAction("achlysApp", SimpleTrapAction, "add_trap_ics");
registerMooseAction("achlysApp", SimpleTrapAction, "add_trap_kernels");
registerMooseAction("achlysApp", SimpleTrapAction, "add_trap_bcs");
registerMooseAction("achlysApp", SimpleTrapAction, "add_material");

InputParameters
SimpleTrapAction::validParams()
{
...
SimpleTrapAction::SimpleTrapAction(InputParameters parameters)
  : Action(parameters),
...
void
SimpleTrapAction::act()
{
  if (_current_task == "add_trap_variables")
  {
  ...
  if (_current_task == "add_trap_kernels")
  {
    addCMKernels();
  }

  if (_current_task == "add_trap_bcs")
  {
...
void
SimpleTrapAction::addCMWaveguidePortsBC()
{
  std::string bc_type;
