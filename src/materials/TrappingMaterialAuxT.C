...
#include "TrappingMaterialAuxT.h"
#include <cstdio>

registerMooseObject("achlysApp", TrappingMaterialAuxT);

InputParameters TrappingMaterialAuxT::validParams()
{
...
TrappingMaterialAuxT::TrappingMaterialAuxT(const InputParameters & parameters)
...
void
TrappingMaterialAuxT::computeQpProperties()
{
