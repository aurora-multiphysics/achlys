...
#include "ExtrinsicTransientTrappingMaterial2.h"
#include <cstdio>
#include "Function.h"

registerMooseObject("achlysApp", ExtrinsicTransientTrappingMaterial2);

InputParameters ExtrinsicTransientTrappingMaterial2::validParams()
{
...
ExtrinsicTransientTrappingMaterial2::ExtrinsicTransientTrappingMaterial2(const InputParameters & parameters)
...
void
ExtrinsicTransientTrappingMaterial2::computeQpProperties()
{
...
if(_q_point[_qp](0)< _xp){
    ...
    Real N3_exponent = -1.0 * _flux * combined_rates * _t;
