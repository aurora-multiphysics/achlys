...
#include "ExtrinsicStaticTrappingMaterialRampingT.h"
#include <cstdio>
#include "Function.h"

registerMooseObject("achlysApp", ExtrinsicStaticTrappingMaterialRampingT);

InputParameters ExtrinsicStaticTrappingMaterialRampingT::validParams()
{
...
//   params.addRequiredParam<Real>("n3", "possible trapping sites");
  ...
  params.addRequiredParam<Real>("initial_T", "placeholder for temperature");
...
ExtrinsicStaticTrappingMaterialRampingT::ExtrinsicStaticTrappingMaterialRampingT(const InputParameters & parameters)
  : ADMaterial(parameters),
    ...
    _T_start(getParam<Real>("initial_T")),
...
void
ExtrinsicStaticTrappingMaterialRampingT::computeQpProperties()
{
