...
#include "BinaryTrappingMaterial.h"
#include <cstdio>
...
BinaryTrappingMaterial::BinaryTrappingMaterial(const InputParameters & parameters)
...
void
BinaryTrappingMaterial::computeQpProperties()
{
