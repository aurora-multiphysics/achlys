...
registerMooseObject("achlysApp", SideMaxValue);

// defineLegacyParams(FindValueOnLine);

InputParameters
SideMaxValue::validParams()
{
...
SideMaxValue::SideMaxValue(const InputParameters & parameters)
...
Real
SideMaxValue::getValueAtPoint(const Point & p)
{
